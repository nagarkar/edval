...
export class TopInfluencerComponent extends SurveyPage {
  ...
  private pickRandomImage() {
    if (this.valueOrderDesc) {
      return Utils.shuffle([
        ...
        //'https://s-media-cache-ak0.pinimg.com/236x/cb/be/55/cbbe550322948552591f6b9b504cdca4.jpg'
        //'http://covetliving.com/wp-content/uploads/2014/01/Never-Let-the-Things-You-Want-Covet-Living.jpg',
        //'https://s-media-cache-ak0.pinimg.com/564x/e7/32/d4/e732d424e87d24c666ac7ac7864cf62c.jpg',
        //'https://s-media-cache-ak0.pinimg.com/564x/f1/52/8c/f1528c20eb8511185439b012622bf8bc.jpg',
        //'https://s-media-cache-ak0.pinimg.com/originals/57/f7/39/57f7396184f4352067831db584ccdf76.jpg',
        //'http://www.medpreps.com/wp-content/uploads/2012/08/interview-strength.jpg',
  ...
  private persistMetricValuesAndNavigate() {
    ...
    setTimeout(()=>{
      this.navigateToNext();
    }, 1000 /* Short delay to allow the page to settle down */)
  }
