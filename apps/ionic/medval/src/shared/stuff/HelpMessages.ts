...
export class HelpMessages {
  ...
  private static helpContent = {
    ...
    SWEEPSTAKES_SHOW_WHEEL: `Show a 'Wheel of Fortune' game to patients on the 'Thank You' page. A patient can 'spin the wheel'
    ...
    SWEEPSTAKES_AWARD_AMOUNT: `If you have enabled the 'Wheel of Fortune' game, patients win a gift card in 
    ...
    SWEEPSTAKES_COST_PER_USE: `If you have enabled the 'Wheel of Fortune' game, this is the amount 
      you will spend on gift cards per patient who plays this game. Usually set to a value between 0.5 and 5 (dollars).`,
    SHOW_JOKES_ON_THANK_YOU_PAGE: `Control whether you want to show jokes on the thank you page. Jokes make people smile,
    ...
    REVIEW_URL: `If a patient is highly likely to give a good review, after a survey, we request patients to provide their
    ...
    REVIEW_URL_FACEBOOK: `In order to get Facebook reviews and ratings, you'll need to make sure that your Page's category is “Local Business”
    ...
    REVIEW_URL_GOOGLE: `Here are the steps to get your Google Page URL into this App:
        <ol style='text-align:left'>
    ...
    REVIEW_URL_YELP: `Here are the steps to get your Yelp Page URL into this App:
        <ol style='text-align:left''>
