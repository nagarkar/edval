 ...
 *
 * Sourced from gmuselli and https://github.com/speedfl/simple-angular-color-picker/blob/master/color-picker.ts
 */
...
@Component({
  ...
  <canvas #chooser style="background:white; margin-top: 20px;" class='center'></canvas>
`
})
