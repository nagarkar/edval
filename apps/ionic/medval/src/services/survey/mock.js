...
export var MockSurveyService = (function (_super) {
    __extends(MockSurveyService, _super);
    function MockSurveyService(utils, accessProvider) {
        _super.call(this, utils, accessProvider);
        Utils.log("created survey)");
    }
    MockSurveyService.prototype.reset = function () {
        MockSurveyService.surveyMap = MockSurveyService.mockMap();
    };
    MockSurveyService.prototype.getId = function (member) {
        return member.id;
    };
    MockSurveyService.prototype.setId = function (member, id) {
        return member.id = id;
    };
    MockSurveyService.prototype.mockData = function () {
        return MockSurveyService.surveyMap;
    };
    MockSurveyService.mockMap = function () {
        var map = new Map();
    ...
    MockSurveyService.surveyMap = MockSurveyService.mockMap();
    MockSurveyService.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    MockSurveyService.ctorParameters = [
        { type: Utils, },
